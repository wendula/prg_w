...
namespace Files
{
    internal class Program
    {
        ...
        class Person
        {
            ...
            public int id; // Automaticky generovane id pro odliseni osob se stejnym jmenem, vahou a vyskou
            ...
            public void SaveToTxt()
            {
                ...
                string filePath2 = "C:\\Users\\Vendula\\OneDrive\\Dokumenty\\škola\\ivt\\programovani\\files\\" + Name + ".txt";
            ...
            public static Person LoadFromTxt()
            {
                ...
                //      chtenou osobu. Nasledne z nej uz jenom prectete informace, vytvorte diky nim novou instanci Person a vratte ji

                Console.WriteLine("Write the name of the person you want to load: ");
                string name = Console.ReadLine();
                string filePath3 = "C:\\Users\\Vendula\\OneDrive\\Dokumenty\\škola\\ivt\\programovani\\files\\" + name + ".txt";
                ...
                if (File.Exists(filePath3))
                {
                    using (StreamReader reader = new StreamReader(filePath3))
                    {
                        ...
                        person.Height = float.Parse(reader.ReadLine());
                        person.Weight = float.Parse(reader.ReadLine());
                    }
                }
            ...
            public void SaveToCsv()
            {
                ...
                string filePath2 = "C:\\Users\\Vendula\\OneDrive\\Dokumenty\\škola\\ivt\\programovani\\files\\" + Name + ".csv";
