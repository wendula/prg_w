...
namespace ClassPlayground
{
    internal class Program
    {
        ...
        {
            rectangle obdelnickos = new rectangle();
            obdelnickos.width = 20;
            obdelnickos.height = 15;
            obdelnickos.Calculate_area();
            obdelnickos.Calculate_aspect_ratio();
            int bodX = 4;
            int bodY = 2;
            obdelnickos.Contains_point(bodX, bodY);
