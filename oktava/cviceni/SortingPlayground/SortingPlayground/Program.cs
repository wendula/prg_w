...
namespace SortingPlayground
{
    internal class Program
    {
        ...
        static int[] BubbleSort(int[] array)
        {
            ...
            {
                for (int i = 0; i < sortedArray.Length-1-j; i++)
                {
        ...
        static int[] SelectionSort(int[] array)
        {
            ...
            for (int j = 0; j < sortedArray.Length; j++)
            {
                ...
                {
                    if (sortedArray[i] > cur_max)
                    {
                        cur_max = sortedArray[i];
                        position_max = i;
                    }
                }
                temp = sortedArray[sortedArray.Length-1-j];
                sortedArray[sortedArray.Length-1-j] = cur_max;
                sortedArray[position_max] = temp;
            }
            return sortedArray;
        }
